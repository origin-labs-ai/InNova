// ============================================================================
// gguf_bridge.h — GGUF loader: GGUF -> AdapterTensors (FP32) -> OIL mixed
// ============================================================================
#pragma once
...
// Supports GGML types: F32, F16, Q4_0, Q4_1, Q5_0, Q5_1, Q8_0, Q8_1, Q6_0, Q2_K.
std::vector<AdapterTensor> load_gguf(const std::string& path, bool verbose = false);

// GGUF -> OIL mixed-precision file.
