// ============================================================================
// ptq_bridge.cpp — raw foreign-dtype weights -> QUANT mixed-precision
// ============================================================================
...
bool ptq_requant_quant(const std::string& input_quant, const BridgeConfig& cfg) {
    ...
    for (const auto& n : names) {
        quant::Tensor ot = reader.read_tensor(n);
