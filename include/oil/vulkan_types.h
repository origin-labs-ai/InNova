#pragma once
#ifndef OIL_VULKAN_TYPES_H
#define OIL_VULKAN_TYPES_H
...
constexpr int VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT = 0x1;
constexpr int VK_MEMORY_PROPERTY_HOST_COHERENT_BIT = 0x2;
constexpr int VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT = 0x10;
