...
// ============================================================================
// WHY: Standard DataLoader loads entire file into RAM. For large datasets on a
// limited RAM machine, standard loading would cause memory overflow. mmap() maps file pages directly into the
