# Research Phase 9: QUANT8 — 256 Centroids Per Block Analysis
...
- **Gap: ~91 dB** — QUANT8 is NOT equivalent to FP32 in terms of precision
...
**If ternary (3 centroids) can match FP16, then QUANT8 (256 centroids) should easily match FP32 quality — IF trained correctly.**
...
| **QUANT8** | **8** | **256** | **Expected: 7.0-7.1** |
| **QUANT4** | **4** | **16** | **Expected: 7.1-7.3** |
...
2. QUANT8 (256 centroids) is 85× more expressive than ternary
...
**256 centroids is mathematically sufficient for practical FP32 equivalence.** The real question is whether the training procedure can exploit this capacity. BitNet b1.58 proves it can for ternary. QUANT8 should be even easier.

The "0% loss" claim for QUANT8 is:
